...
export default function BankStatusCard({ bankConnected, bankAccount, onOpenModal }) {
  return (
      ...
      {bankConnected ? (
        <div className="space-y-8 animate-in fade-in">
          ...
          <div className="space-y-2 italic">
            <h3 className="font-['Unbounded'] text-lg font-black uppercase tracking-tight">Synced.</h3>
