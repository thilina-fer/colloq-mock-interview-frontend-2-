...
const ProcessSection = () => (
  <section id="process" className="py-40 px-6 md:px-12 max-w-7xl mx-auto">
    <Reveal animation="fade-up">
      <div className="text-center mb-32">
        <h2 className="font-['Unbounded'] text-4xl md:text-6xl font-black uppercase mb-6 italic tracking-tight">
          The Workflow
        </h2>
        <div
    ...
    <div className="grid md:grid-cols-3 gap-20 md:gap-12 relative">
      ...
      {PROCESS_ITEMS.map((item, i) => (
        <Reveal key={item.step} animation="fade-up" delay={i * 200}>
          <div className="relative group p-8 hover:bg-white transition-all duration-500 border border-transparent hover:border-neutral-100">
            <div
