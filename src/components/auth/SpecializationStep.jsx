...
const SpecializationStep = ({ specs, form, toggleSpec }) => (
  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-[250px] overflow-hidden">
    {specs.map(({ id, name, Icon }) => {
      ...
      return (
        <button
          ...
          className={`flex flex-col items-start gap-3 p-4 border-[2px] transition-all text-left ${
            selected
